...
public class CmdNPC extends MobNPC {

    public CmdNPC(FullChunk chunk, CompoundTag nbt) {
    ...
    public void spawnTo(Player player) {
        if (!this.hasSpawned.containsKey(player.getLoaderId())) {
            ...
            //this.inventory.setItemInHand(new Item(Integer.valueOf(itemthings[0]),Integer.valueOf(itemthings[1])));
